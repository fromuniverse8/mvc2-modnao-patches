...
| <img src="./stg07.lsd.png" alt="LSD River Stage in gameplay" width="320"> | **LSD River Stage**<br>The ice has melted. So has reality.<br><br>[Download patch](./stg07.lsd.mnp.zip) | `STG07POL.BIN`<br>`STG07TEX.BIN` | herb |
